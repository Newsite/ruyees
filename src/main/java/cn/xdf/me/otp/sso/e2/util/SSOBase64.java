package cn.xdf.me.otp.sso.e2.util;
...
/**
 * Implementation of MIME's Base64 encoding and decoding conversions. Optimized
 * code. (raw version taken from oreilly.jonathan.util, and currently
 * com.sun.org.apache.xerces.internal.ds.util.Base64)
 * 
 ...
 */
public class SSOBase64 {

	/** {@link java.util.logging} logging facility */
	static java.util.logging.Logger log = java.util.logging.Logger
			.getLogger(SSOBase64.class.getName());

	/** Field BASE64DEFAULTLENGTH */
	public static final int BASE64DEFAULTLENGTH = 76;

	/** Field _base64length */
	static int _base64length = SSOBase64.BASE64DEFAULTLENGTH;
