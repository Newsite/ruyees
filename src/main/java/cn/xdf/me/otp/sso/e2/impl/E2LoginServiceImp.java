...
import cn.xdf.me.otp.sso.ILoginService;
import cn.xdf.me.otp.sso.e2.constant.SSOToE2Constant;
import cn.xdf.me.otp.sso.e2.util.AESX3;
import cn.xdf.me.otp.sso.e2.util.IPUtil;
import cn.xdf.me.otp.sso.e2.vo.OnlineVM;
	...
	public boolean login(String _username, String _password) throws Exception {
		...
		try {
			...
			if (resultCode.startsWith("1")) {
				...
				System.out
						.println("e2TokenCookieValue===" + e2TokenCookieValue);
				if (!StringUtils.isBlank(e2TokenCookieValue)) {
					...
					org.apache.commons.httpclient.Cookie cookie = new org.apache.commons.httpclient.Cookie(
							...
							e2TokenCookieValue, "/", c1.getTime(), true);
