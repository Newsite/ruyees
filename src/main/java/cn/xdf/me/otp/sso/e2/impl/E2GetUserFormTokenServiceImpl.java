package cn.xdf.me.otp.sso.e2.impl;
...
import cn.xdf.me.otp.common.json.JsonUtils;
import cn.xdf.me.otp.sso.IGetUserFromTokenService;
import cn.xdf.me.otp.sso.e2.constant.SSOToE2Constant;
import cn.xdf.me.otp.sso.e2.util.AESX3;
import cn.xdf.me.otp.sso.e2.util.CookieHelper;
import cn.xdf.me.otp.sso.e2.vo.UserModel;
...
public class E2GetUserFormTokenServiceImpl implements IGetUserFromTokenService {
	...
	public UserModel getCurrentUser(HttpServletRequest request,
		...
		if (tokenStr != null) {
			Map<String, Object> map = JsonUtils.readObjectByJson(tokenStr,
					Map.class);
			...
			model.setLoginName(ComUtils.getLoginNameByEmail(map.get("Email")
					.toString()));
			return model;
		}
		return null;
