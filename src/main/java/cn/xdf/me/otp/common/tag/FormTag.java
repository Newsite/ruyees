package cn.xdf.me.otp.common.tag;
...
/**
 * 对jodd Form 做了封装，使其支持制定bean进行赋值
 * 
 * 
 * @see jodd.servlet.tag.FormTag
 * @author Zaric
 * @date 2013-6-1 上午12:51:15
 */
public class FormTag extends BodyTagSupport {
	...
	private String populateForm(String html, FieldResolver resolver) {
	...
	public static void main(String[] args) {
		System.out.println("asdasd,asdasd".split(",").length);
	}
