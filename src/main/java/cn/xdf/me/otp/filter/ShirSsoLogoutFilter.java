...
public class ShirSsoLogoutFilter extends LogoutFilter {
	 ...
	 * {@link #getRedirectUrl(javax.servlet.ServletRequest, javax.servlet.ServletResponse, org.apache.shiro.subject.Subject)
	 ...
	 * @return {@code false} always as typically no further interaction should
	 *         be done after user logout.
	 * @throws Exception
	...
	protected boolean preHandle(ServletRequest request, ServletResponse response)
		...
		try {
			...
			CookieHelper.clearCookie(req, res, ssoToE2Constant.getCookieName());
			subject.logout();
