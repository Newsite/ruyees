...
<form action="${ctx}/group/operPackage/save" method="post">
  <input type="hidden" id="fdId" name="fdId" value="${bean.fdId}"/>
    <div class="modal-header">
      <button type="button" class="close" data-dismiss="modal">x</button>
      <h5 id="update-user-label">学术作业包</h5>
    </div>
    <div class="modal-body">
    <table class="table">
	<tr>
	  <th width="20%">作业包名称</th>
	  <td><input type="text" id="fdName" name="fdName" value="${bean.fdName}" class="inpTd input-xlarge required"/></td>
	</tr>
	<tr>
	  <th>备注</th>
