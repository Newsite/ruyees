...
function checkIdentityCard() {
	...
	$.ajax({
		...
		success : function(data) {
			if (data > 0) {
				$("#fdIdentityCardLabel").html("This Identity Card number has been registered.").show();
				$("#fdIdentityCard").val("");
			} else {
				$("#fdIdentityCardLabel").hide();
			}
...
<div class="page-header">
	<a href="${ctx}/register/list" class="tile-return">返回登录</a>
...
<fieldset>
	...
	<div class="control-group">
		...
		<div class="controls">
			<input type="text" name="notifyEntity.realName" id="usr-input" class="input-xlarge required" maxlength="20" placeholder="请输入您的姓名" />
		</div>
	</div>
	<div class="control-group">
	  <label class="control-label" for="ID-input"><span class="text-error">*</span> 身份证号码</label>
	  <div class="controls">
	    <input type="text" name="fdIdentityCard" id="ID-input" class="input-xlarge required isIdCardNo" maxlength="18" placeholder="请输入您的身份证号码" onblur="checkIdentityCard();"/>
	    <label id="fdIdentityCardLabel" class="text-error" style="display: none;"></label>
	  </div>
	</div>
	<div class="control-group">
	...
	<div class="control-group">
	  ...
	  <div class="controls">
	    ...
	    <input type="radio" id="male" name="fdSex" value="M" checked/> 男</labal>
	    <labal class="radio inline">
	    <input type="radio" id="female" name="fdSex" value="F" /> 女</labal>
	  </div>
	</div>
	<div class="control-group">
	  <label class="control-label" for="birth-input"><span class="text-error">*</span> 生日</label>
	  <div class="controls">
	    <input type="text" name="fdBirthDay" id="birth-input" class="input-xlarge required" placeholder="请输入您的出生日期" />
	  </div>
	</div>
  <div class="control-group">
    <label class="control-label"><span class="text-error">*</span> 血型</label>
    <div class="controls">
      <labal class="radio inline">A<input type="radio" id="A" name="fdBloodType" value="A" checked /></labal>
      <labal class="radio inline">B<input type="radio" id="B" name="fdBloodType" value="B" /></labal>
      <labal class="radio inline">AB<input type="radio" id="AB" name="fdBloodType" value="AB" /></labal>
      <labal class="radio inline">O<input type="radio" id="O" name="fdBloodType" value="O" /></labal>
      <labal class="radio inline">不详<input type="radio" id="OTHER" name="fdBloodType" value="OTHER" /></labal>
    </div>
  </div>
  <div class="control-group">
    <label class="control-label" for="wbid-input">微博ID</label>
    <div class="controls">
      <input type="text" name="fdMicroBlog" id="wbid-input" class="input-xlarge" maxlength="20" placeholder="请输入您的微博ID" />
    </div>
  </div>
  <div class="control-group">
    <label class="control-label" for="mail-input"><span class="text-error">*</span> 个人邮箱</label>
    <div class="controls">
      <input type="text" name="notifyEntity.fdEmail" id="mail-input" class="input-xlarge required email" placeholder="请输入您的个人邮箱" />
    </div>
  </div>
  <div class="control-group">
    <label class="control-label" for="mobl-input"><span class="text-error">*</span> 手机</label>
    <div class="controls">
      <input type="text" name="notifyEntity.fdMobileNo" id="mobl-input" class="input-xlarge required isMobile" maxlength="11" placeholder="请输入您的手机号码" />
    </div>
  </div>
  <div class="control-group">
    <label class="control-label" for="award-input">所获奖项/所持证书</label>
    <div class="controls">
      <input type="text" name="fdCertificate" id="award-input" class="input-xlarge" maxlength="50" placeholder="请输入您所获奖项或所持证书" />
    </div>
  </div>
  <div class="control-group">
    <label class="control-label"><span class="text-error">*</span> 爱好/特长</label>
    <div class="controls">
      	我擅长/喜欢&nbsp;<input type="text" name="fdHobby" class="span2 required input-underline" maxlength="20"/>， 我曾经&nbsp;
      	<input type="text" name="fdOldHobby" class="span2 required input-underline" maxlength="50"/>
    </div>
  </div>
  <div class="control-group">
    <label class="control-label" for="pride-input"><span class="text-error">*</span> 最自豪的事情</label>
    <div class="controls">
      <input type="text" name="fdPride" id="pride-input" class="required input-xlarge" maxlength="100" placeholder="请输入您最自豪的事情" />
    </div>
  </div>
  <div class="control-group">
    <label class="control-label" for="regret-input"><span class="text-error">*</span> 最遗憾的事情</label>
    <div class="controls">
      <input type="text" name="fdPity" id="regret-input" class="required input-xlarge" maxlength="100" placeholder="请输入您最遗憾的事情" />
    </div>
  </div>
  <div class="control-group">
    <label class="control-label" for="dream-input"><span class="text-error">*</span> 最梦想实现的事情</label>
    <div class="controls">
      <input type="text" name="fdDram" id="dream-input" class="required input-xlarge" maxlength="100" placeholder="请输入您最梦想实现的事情" />
    </div>
  </div>
</fieldset>
...
<div class="page-footer">
  <button type="submit" class="btn btn-info btn-sign-up"><i class="icon-ok-circle icon-white"></i>&nbsp;注 册</button>
</div>
</form>
</div>
</div>
