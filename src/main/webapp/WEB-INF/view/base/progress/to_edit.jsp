	...
	jQuery(document).ready(function() {
		$("#inputForm").validate({
			...
			submitHandler : function(form) { //通过之后回调
				...
				document.form.action = '${ctx}/coach/progress/toSave';
...
<body>
  <form class="form-horizontal" id="inputForm" method="" action="" name="form">
    <input type="hidden" name="acceptUser[0].person.fdId" value="${newTeachId}" />
    <div class="well">
      ...
      <button class="btn btn-info" type="submit" value="提交" id="saveBtn"><i class="icon-envelope icon-white"></i>&nbsp;发送</button>
    </div>
  </form>
</body>
</html>