...
<c:set var="flowId" value="${bean.phase.stage.project.fdId}" />
<!DOCTYPE html>
<html lang="zh_CN">
<head>
								...
								.validate(
										{
											...
											submitHandler : function(form) { // 通过之后回调
												...
												document.form.action = '${ctx}/campus/flow/edit/bamCourseware/save';
...
<body>
  <form class="form-horizontal" method="" id="inputForm" action="" name="form">
    <input type="hidden" name="fdId" value="${bean.fdId}" /> <input type="hidden" name="flowId" value="${flowId}" /> <input
      ...
      type="hidden" name="stage" value="4" /> <input type="hidden" name="step" value="1" />
    <section id="set-exam">
      <div class="well">
        ...
        <table class="table">
          <tr>
            <th>课件要求</th>
            <td colspan="3"><tags:edit editid="couReq" name="couReq" value="${bean.couReq}" width="540px;"
                height="200px;"></tags:edit></td>
          </tr>
          <tr>
            <th>课件资料</th>
            <td colspan="3"><tags:edit editid="couNeedInfo" name="couNeedInfo" value="${bean.couNeedInfo}"
