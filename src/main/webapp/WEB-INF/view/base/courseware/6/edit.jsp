...
<script type="text/javascript">
	function submitCourseware() {
		...
		document.form.action = '${ctx}/coach/courseware/save/6';
          ...
          <j:if test="${show eq true}">
            <j:ifelse test="${bamCourseware.through eq true}">
              <j:then>
                ...
                <tr>
                  <th>评价</th>
                  <td colspan="3">${bamCourseware.fdComment}</td>
                </tr>
                <tr>
		            <th width="10%">打包下载</th>
		            <td colspan="3">
		            	<a href="${ctx}//coach/courseware/data/zipExp?fdId=${bamCourseware.fdId}">下载</a>
		            </td>
		          </tr>
            ...
            <j:iter items="${bamCoursewareItemList}" var="bean" status="vstatus">
              <tr>
                ...
                <td><j:switch value="${bean.status}">
                    ...
                    <j:case value="2">
                      <a href="${ctx}/coach/courItem/edit/6/${bean.fdId}">审批</a>
                    </j:case>
                    <j:case value="3">
                      <a href="${ctx}/coach/courItem/view/6/${bean.fdId}">查看</a>
                      <a href="${ctx}/coach/courItem/edit/6/${bean.fdId}">修改评语</a>
                    </j:case>
                    <j:case value="4">
                      <a href="${ctx}/coach/courItem/view/6/${bean.fdId}">查看</a>
                      <a href="${ctx}/coach/courItem/edit/6/${bean.fdId}">修改评语</a>
