  ...
  <section id="exam-list">
    <div class="well">
      <div class="page-header">
        <a href="${ctx}/group/report/stageList/${projectId}/${newTeachId}" class="tile-return">返回上页</a>
        <h4>集团备课跟踪</h4>
        <p>
          在本模块中，您可以跟踪新教师的备课进度。
        </p>
                      ...
                      <j:iter items="${operation.bamIndexs}" var="bamIndex" status="vs2">
                        ...
                        <j:ifelse test="${bamIndex.status >= 2}">
                          <j:then>
                            ...
                            <span class="text-error">${bamIndex.fdToValue}分</span>
                            <br />
                          </j:then>
              ...
              <tr>
                ...
                <td><j:if test="${bean.fdIndex eq 1}">
                    <j:iter items="${bean.cws}" var="movie" status="vs1">
                      ...
                      <j:ifelse test="${movie.through eq true}">
                        <j:then>
                          <span class="text-success">${movie.fdName}<br /></span>
                        </j:then>
                        <j:else>${movie.fdName}<br /></j:else>
                      </j:ifelse>
                    </j:iter>
                  ...
                  </j:if> <j:if test="${bean.fdIndex eq 3}">
                  ...
                  </j:if> <j:if test="${bean.fdIndex eq 4}">
