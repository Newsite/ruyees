...
<link rel="stylesheet" type="text/css" href="${ctx}/resources/css/otp_iframe.css?id=12">
...
<body oncontextmenu="return false" onselectstart="return false" ondragstart="return false" onbeforecopy="return false" onmouseup="document.selection.empty()" oncopy="document.selection.empty()" onselect="document.selection.empty()">
  <div class="iframe-container">
    <div class="stepsTab-cont-top">
      <p class="location">
        <a class="active" href="${ctx}/trainee/step/${name}/6/1"><b class="sjl"></b><b class="sjl2"></b>6.1 第六关：课件确认<b
          class="sjr"></b><b class="sjr2"></b></a>
        <j:ifelse test="${allUploaded eq true}">
          <j:then>
            <a href="${ctx}/trainee/step/${name}/6/2"><b class="sjl"></b><b class="sjl2"></b>6.2 审批课件<b class="sjr"></b><b
              class="sjr2"></b></a>
          </j:then>
          <j:else>
            <a href="#"><b class="sjl"></b><b class="sjl2"></b>6.2 审批课件<b class="sjr"></b><b class="sjr2"></b></a>
          </j:else>
        </j:ifelse>
      </p>
      <p><label class="label">闯关说明</label>&nbsp;${content.content.item.fdRemarke}</p>
    </div>
    ...
    <j:ifelse test="${allUploaded eq true}">
      <j:then>
        <div class="success_box well">
          <div>
                              你已经完成了&nbsp;<span class="text-info">课件确认</span>&nbsp;中的提交任务。请进入下一步&nbsp;
            <span class="text-info"><a href="${ctx}/trainee/step/${name}/6/2" rel="tooltip">审批课件</a></span>&nbsp;
            <a href="${ctx}/trainee/step/${name}/6/2" rel="tooltip" title="点击进入" class="icon-nextStep"></a>
          </div>
        </div>
      </j:then>
      <j:else>
    ...
    <div class="content-box clearfix">
      <div class="fs14">
        <strong>课件管理</strong>&nbsp;&nbsp;&nbsp;如果课件不需要修改，请直接点击提交。
      </div>
