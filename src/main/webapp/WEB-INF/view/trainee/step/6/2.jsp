			...
			$.ajax({
				...
				success : function(msg) {
					if (msg != "-1") {
						...
						//$this.prevAll(".uploadify").children("object").remove();
						...
						if (msg == "1") {
							...
							//window.location.href = '${ctx}/trainee/step/${name}/6/2';
						}
					} else {
...
<body oncontextmenu="return false" onselectstart="return false" ondragstart="return false" onbeforecopy="return false" onmouseup="document.selection.empty()" oncopy="document.selection.empty()" onselect="document.selection.empty()">
  <div class="iframe-container">
    <div class="stepsTab-cont-top">
      <p class="location">
        <a href="${ctx}/trainee/step/${name}/6/1"><b class="sjl"></b><b class="sjl2"></b>6.1 第六关：课件确认<b class="sjr"></b><b
          class="sjr2"></b></a> <a class="active" href="${ctx}/trainee/step/${name}/6/2"><b class="sjl"></b><b
          class="sjl2"></b>6.2 审批课件<b class="sjr"></b><b class="sjr2"></b></a>
      </p>
      <p>
    ...
    <j:if test="${allUploaded eq true && throughStatus[6][1] != 1}">
      <div class="success_box well">
        <div>
          	你已经完成了全部课件的确认任务。<br />请耐心等待指导教师&nbsp;<span class="text-info">${member.guid.realName}</span>
          	&nbsp;的审批。如果久未批复，请及时提醒TA<a href="#" onclick="top.location='${ctx}/notify/toAdd/${member.guid.fdId}'" rel="tooltip" title="站内消息" class="icon-online"></a>
          	<a href="mailto:${member.guid.fdEmail}?subject=请多关照" rel="tooltip" title="发送邮件" class="icon-mail"></a>。
        </div>
      </div>
    </j:if>
    <j:if test="${throughStatus[6][1] == 1}">
      <div class="success_box well">
                         指导教师&nbsp;<span class="text-info">${member.guid.realName}</span>&nbsp;说，“${content.coursewares[0].fdComment}”<br />恭喜你完成&nbsp;
          <span class="text-info">课件确认</span>&nbsp;关卡！快去看看你的&nbsp;
          <span class="text-info"><a href="#" rel="tooltip" onclick="goTop(function(){top.location.href='${ctx}/trainee/success/${name}';});">证书</a></span>&nbsp;
          <a href="#" rel="tooltip" title="查看证书" class="icon-nextStep" onclick="goTop(function(){top.location.href='${ctx}/trainee/success/${name}';});"></a>
      </div>
    </j:if>
