...
<script type="text/javascript">
	function query() {
		...
		document.form1.action = '${ctx}/common/content';
...
<body>
  <form class="query" name="form1">
    <input type="hidden" name="method" value="${method}" /> <input type="hidden" name="itemindex" value="${itemindex}" />
  ...
  <form class="form-horizontal" id="form-video" action="" name="form">
    ...
    <tags:pagination page="${page}" searchParams="fdName=${fdName }&contentId=${contentId}&itemindex=${itemindex}" paginationSize="7" />
  </form>
</body>
</html>